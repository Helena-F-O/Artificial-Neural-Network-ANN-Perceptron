...
# Treinamento do perceptron para a porta lógica AND com limite de 50 iterações
weights_and = perceptron_train(and_inputs, and_outputs, max_iterations=50)

# Conjunto de treinamento para a porta lógica OR
or_inputs = np.array([[0, 0], [0, 1], [1, 0], [1, 1]])
or_outputs = np.array([-1, 1, 1, 1])

# Treinamento do perceptron para a porta lógica OR com limite de 50 iterações
weights_or = perceptron_train(or_inputs, or_outputs, max_iterations=50)

# Conjunto de treinamento para a porta lógica XOR
xor_inputs = np.array([[0, 0], [0, 1], [1, 0], [1, 1]])
xor_outputs = np.array([-1, 1, 1, -1])

# Treinamento do perceptron para a porta lógica XOR com limite de 50 iterações
weights_xor = perceptron_train(xor_inputs, xor_outputs, max_iterations=50)
